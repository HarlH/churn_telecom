...
def class_weights(y_train):
    """
    Calculates class weights to balance the model
    """
...
def train_model(X_train, y_train, class_weights):
    """
    Trains the CatBoost model with optimized hyperparameters
    """
...
def save_model(model, preprocessor, path):
    """
    Saves the trained model and preprocessor in a pipeline
    """
